...
public abstract class Hilt_AnimalsNearYouFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnimalsNearYouFragment() {
    super();
  }

  Hilt_AnimalsNearYouFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnimalsNearYouFragment_GeneratedInjector) this.generatedComponent()).injectAnimalsNearYouFragment(UnsafeCasts.<AnimalsNearYouFragment>unsafeCast(this));
    }
  }
